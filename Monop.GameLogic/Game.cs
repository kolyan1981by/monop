...
namespace GameLogic
{
    ...
    public class Game
    {
        ...
        public int AmountOfPay { get; set; }
        ...
        {
            return pcount > 0 && Players[0].Name == uname;
        }
        ...
        public Game()
        {
            ...
            conf = new GameConfig();
            //init map cells
            Cells = GameHelper.LoadLands().OrderBy(x => x.Id).ToArray();
        ...
        public void ToPay(bool needFinish = true, Player to = null)
        {
            if (Curr.IsBot)
            {
                PlayerAction.Pay(this, AmountOfPay, to);
                if (needFinish) FinishStep("paid_" + AmountOfPay.PrintMoney());
            }
            else
                SetState(GameState.Pay);
        }
