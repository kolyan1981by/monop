...
namespace Monop.www.Controllers
{
    public class AjaxController : BaseController
    {
        ...
        public string PlayerCells()
        {
            ...
            var res = RenderRazorViewToString("Controls/Game/PlayerCells", g);
            return res;
        }
        ...
        public ActionResult Mortgage(string str)
        {
            ...
            if (Request.IsAuthenticated)
            {
                var actRes = GameAction.Mortgage(g, str, CurrUser);
                if (actRes)
        ...
        public ActionResult Trade(string str)
        {
            ...
            {
                GameAction.InitTrade(g, str, CurrUser);
        ...
        public ActionResult Build(string str)
        {
            ...
            if (Request.IsAuthenticated)
            {
                var actRes = GameAction.BuildOrSell(g, str, "build", CurrUser);
                if (actRes)
            ...
            var jsonData = new
            {
                ...
                PlayerCells = RenderRazorViewToString("Controls/Game/PlayerCells", g),
        ...
        public ActionResult SellHouses(string str)
        {
            ...
            if (Request.IsAuthenticated)
            {
                var actRes = GameAction.BuildOrSell(g, str, "sell", CurrUser);
            }
